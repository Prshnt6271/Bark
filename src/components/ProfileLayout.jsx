            ...
            <nav className="space-y-1">
              {sections.map((section) => (
                <button
                  ...
                  className={`w-full text-left py-2.5 px-3 rounded transition text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-green-400 ${
